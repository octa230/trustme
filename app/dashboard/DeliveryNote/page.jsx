...
export default function page() {
  ...
  return (
    <div>
      <h1 className='text-danger'>Delivery Note</h1>
      <Row>
                ...
                <Form>
                  <Form.Group>
                      <Form.Label>Delivery Note Number</Form.Label>
                        <Form.Control type='text' placeholder='101' disabled/>
                      </Form.Group>
                  <Form.Group>
                      <Form.Label>LPO Number</Form.Label>
                        <Form.Control type='text' placeholder='101XXX'/>
                      </Form.Group>
                      <Form.Group>
                        <Calender title='Delivery Note Date'/>
                      </Form.Group>
                      <Form.Group>
